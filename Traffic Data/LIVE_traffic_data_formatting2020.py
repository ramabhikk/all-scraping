...
DATA_MONTH = str(prev_month.month)
DATA_YEAR = str(prev_month.year)
...
OUT_PATH = r"C:\Program Files" # output location for the csv
...
DATA_FOLDER = os.path.join(r"C:\Users\abhir\Desktop\Python_Codes\Traffic Data", DATA_MONTH + "-" + DATA_YEAR) # folder containing all of the newly downloaded traffic data
