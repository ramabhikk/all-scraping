...
if __name__ == "__main__":
    ...
    ## Update this line (A folder of prev_month-year will be created and files will be downloaded here)
    folder = r'C:\Users\abhir\Desktop\Python_Codes\Traffic Data' 
